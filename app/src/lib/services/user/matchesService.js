import matchesEndpoints from '../../endpoint/user/matches';
...
const matchesService = {
  ...
  async getTournamentMatches(tournamentId, params = {}) {
    try {
      const response = await apiClient.get(matchesEndpoints.getTournamentMatches(tournamentId), { params });
      return response.data;
    } catch (error) {
      console.error(`Error fetching tournament matches for tournament ${tournamentId}:`, error);
      throw error;
    }
  },
  ...
  async getTeamMatches(teamId, params = {}) {
    try {
      const response = await apiClient.get(matchesEndpoints.getTeamMatches(teamId), { params });
      return response.data;
    } catch (error) {
      console.error(`Error fetching team matches for team ${teamId}:`, error);
      throw error;
    }
  },
  ...
  async getUpcomingMatches(params = {}) {
    try {
      const response = await apiClient.get(matchesEndpoints.getUpcomingMatches, { params });
      return response.data;
    } catch (error) {
  ...
  async getCompletedMatches(params = {}) {
    try {
      const response = await apiClient.get(matchesEndpoints.getCompletedMatches, { params });
      return response.data;
    } catch (error) {
